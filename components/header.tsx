        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-10 items-center justify-between text-sm">
            <div className="flex items-center gap-6">
              <a href="mailto:sales@wenze-global.com" className="flex items-center gap-2 hover:text-accent transition-colors">
                <Mail className="h-4 w-4" />
                <span className="hidden sm:inline">sales@wenze-global.com</span>
              </a>
            ...
            <div className="hidden md:block">
              WENZE Power | Reliable Power Solutions
            </div>
          </div>
        </div>
      </div>
